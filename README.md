...
[CLI Wiki page](https://github.com/xenioplatform/go-xenio/wiki/Command-Line-Options)), but we've
...
Please see the [Developers' Guide](https://github.com/xenioplatform/go-xenio/wiki/Developers'-Guide)
