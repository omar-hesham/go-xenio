...
# 1. install xenio-cli for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for xenio-cli
# 5. create xenio-cli, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable XENIO_SOCKET
...
!define GROUPNAME "Xenio"
!define APPNAME "xenio-cli"
!define DESCRIPTION "Official Go implementation of the Xenio protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since xenio-cli is installed global
