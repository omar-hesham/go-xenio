...
const (
	...
	MasterBlockIncrement = 20 // changes in the numbering of master block numbers
)
...
// HasStakers returns true if there is at least one staker in list
func (s *StakerSnapshot) HasStakers() bool {
	var hasStakers bool
	s.Stakers.Range(
		func(a, s interface{}) bool {
			hasStakers = true
			return false
		})
	return hasStakers
