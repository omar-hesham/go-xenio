...
//
// github.com/xenioplatform/go-xenio/wiki/Management-APIs#personal_sign
...
//
// github.com/xenioplatform/go-xenio/wiki/Management-APIs#personal_ecRecover
...
func (s *PublicBlockChainAPI) rpcOutputBlock(b *types.Block, inclTx bool, fullTx bool) (map[string]interface{}, error) {
	...
	fields := map[string]interface{}{
		...
		"isSuperBlock":     hexutil.Bytes(head.SuperBlock),
	}
...
//
// github.com/xenioplatform/wiki/wiki/JSON-RPC#eth_sign
